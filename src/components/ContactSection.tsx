    ...
    <section id="contact" className="py-20 px-6 bg-background">
      <div className="container mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              <Card className="p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground mb-1">{t('contact.address.title')}</h4>
              ...
              <Card className="p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground mb-1">{t('contact.phone.title')}</h4>
                    <p className="text-muted-foreground">
              ...
              <Card className="p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground mb-1">{t('contact.email.title')}</h4>
                    <p className="text-muted-foreground">
              ...
              <Card className="p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground mb-1">{t('contact.hours.title')}</h4>
                    <p className="text-muted-foreground">
          ...
          {/* Mapa */}
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold mb-6">{t('contact.location')}</h3>
            <Card className="p-6">
            ...
            <Card className="p-6 bg-card text-card-foreground border py-6 shadow-sm">
              <h4 className="font-semibold text-foreground mb-3">{t('contact.howToGet')}</h4>
